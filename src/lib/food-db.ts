...
const rawFoodItems: FoodItem[] = [
  ...
  {
    id: 'b06',
    name: 'Leche de arroz sin azúcar',
    category: 'beverage',
    energyKcal: 47,
    proteinG: 0.3,
    carbsG: 9.2,
  ...
  {
    id: 'vg04',
    name: 'Burguesa vegana (tipo Beyond Meat)',
    category: 'vegan',
    energyKcal: 250,
    proteinG: 20,
    carbsG: 5,
